...
void UFullMapUserWidget::NativeConstruct()
{
...
FReply UFullMapUserWidget::NativeOnMouseButtonDown(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
...
void UFullMapUserWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
...
FBox UFullMapUserWidget::CalculateLevelBounds(UWorld* World) const
{
...
FVector2D UFullMapUserWidget::WorldToMap(const FVector& WorldLocation, const FVector2D& MapSize) const
{
...
int32 UFullMapUserWidget::NativePaint(
