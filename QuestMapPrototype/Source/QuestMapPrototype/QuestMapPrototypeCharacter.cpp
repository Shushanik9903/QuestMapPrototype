...
void AQuestMapPrototypeCharacter::NotifyControllerChanged()
{
...
void AQuestMapPrototypeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AQuestMapPrototypeCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AQuestMapPrototypeCharacter::Look);
	}
	else
	{
...
void AQuestMapPrototypeCharacter::Jump()
{
	Super::Jump();
...
void AQuestMapPrototypeCharacter::StopJumping()
{
	Super::StopJumping();
...
void AQuestMapPrototypeCharacter::Landed(const FHitResult& Hit)
{
	Super::Landed(Hit);
